...
## Como jogar
- Arraste uma das três peças exibidas abaixo do tabuleiro e solte sobre a grade 8x8.
- A peça só é posicionada se todos os blocos estiverem em espaços livres.
- Linhas completas (horizontais ou verticais) são removidas, rendem pontos extras e disparam um som de limpeza acompanhado de uma manchete animada perto da pontuação.
...
- `clear-sound.mp3` — efeito de som ao limpar linhas ou colunas.
